...
import com.example.tyb.utils.ConstantUtil;
    ...
    protected InjectionConfig getInjectionConfig(String mapperTag) {
        return new InjectionConfig() {
            ...
            public String outputFile(TableInfo tableInfo) {
                return getResourcePath() + "/"+mapperTag+"/" + tableInfo.getEntityName() + "Mapper.xml";
            }
        }));
    }
        ...
        return new DataSourceConfig()
                ...
                .setTypeConvert(new MySqlTypeConvert() {
                    ...
                    public IColumnType processTypeConvert(GlobalConfig globalConfig, String fieldType) {
                        if (ConstantUtil.BIT.equals(fieldType.toLowerCase())) {
                            return DbColumnType.BOOLEAN;
                        }
                        if (ConstantUtil.TINYINT.equals(fieldType.toLowerCase())) {
                            return DbColumnType.BOOLEAN;
                        }
                        if (ConstantUtil.DATE.equals(fieldType.toLowerCase())) {
                            return DbColumnType.LOCAL_DATE;
                        }
                        if (ConstantUtil.TIME.equals(fieldType.toLowerCase())) {
                            return DbColumnType.LOCAL_TIME;
                        }
                        if (ConstantUtil.DATETIME.equals(fieldType.toLowerCase())) {
...
//                .setUrl("jdbc:mysql://10.5.151.180:3306/test?useUnicode=true&characterEncoding=UTF-8&&useSSL=false");
     ...
     * @return
     */
    public AutoGenerator getDefaultAutoGenerator(String tableName) {
